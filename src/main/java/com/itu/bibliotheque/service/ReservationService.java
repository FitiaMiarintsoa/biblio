...
public class ReservationService {
    ...
    public Reservation reserver(Adherent adherent, Exemplaire exemplaire, LocalDate dateReservation) {
        int nbJour = 0;
        int quotaReservation = Integer.MAX_VALUE;
        ...
        int nbReservationsActives = reservationRepository.countByAdherentAndStatutIn(
            adherent,
            List.of("en_attente", "valide", "confirmee")
        );
    ...
    public Reservation demanderReservation(Adherent adherent, Exemplaire exemplaire, LocalDate dateReservation) {
        int nbJour = 0;
        int quotaReservation = Integer.MAX_VALUE;
